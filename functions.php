...
function easymag_scripts() {
	...
	// Weather Icons
	wp_enqueue_style( 'meteocons-font', get_template_directory_uri() . '/fonts/meteocons-font/stylesheet.css', array(), '4.4.0', '' );
	// Enqueue Swiper.css
 ...
 * Load Widgets file
 */
require get_template_directory() . '/inc/widgets/widget-tabs-content.php';
require get_template_directory() . '/inc/widgets/widget-posts-layout-1.php';
require get_template_directory() . '/inc/widgets/widget-posts-layout-2.php';
require get_template_directory() . '/inc/widgets/widget-posts-layout-3.php';
require get_template_directory() . '/inc/widgets/widget-posts-layout-4.php';
 ...
 * Recommend Plugins
 */
require get_template_directory() . '/inc/plugins-recommended.php';
/**
